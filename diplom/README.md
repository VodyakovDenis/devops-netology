...
* Для запуска ci/cd терраформ использовался раннер запущенный на VM (создан там-же в прошлых ДЗ), для хранения статуса используется встроенная в гитлаб инфраструктура "Terraform states"
